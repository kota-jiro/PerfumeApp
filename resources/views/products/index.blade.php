<x-app-layout>
    ...
    <div class="modal fade" id="productModal" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-dark mx-3 px-3">
    ...
    <script>
        ...
        document.getElementById('checkoutBtn').addEventListener('click', () => {
            if (selectedProduct) {
                document.getElementById('checkoutProductTitle').innerText = selectedProduct.title;

                // Optionally set form action if needed
                const checkoutForm = document.getElementById('checkoutForm');
                checkoutForm.action = `/checkout/${selectedProduct.id}`;
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkoutModal.addEventListener('show.bs.modal', function(event) {
                const button = event.relatedTarget; // This is the button that triggered the modal
                if (!button) return;
                ...
                checkoutProductTitle.textContent = productTitle;
